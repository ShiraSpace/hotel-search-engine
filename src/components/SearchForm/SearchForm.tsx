...
export function SearchForm({ onSearch }: Props): JSX.Element {
  ...
  const isComplete = skiSiteId !== '' && groupSize !== '' && fromDate !== '' && toDate !== '';
  ...
  return (
    <form onSubmit={handleSubmit} className="search-bar">
      <div className="search-segment">
        <svg className="seg-icon" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <select
          ...
          className="seg-text bg-transparent border-none outline-none w-full cursor-pointer"
        >
      ...
      <div className="search-segment">
        ...
        <input
          ...
          className="seg-text bg-transparent border-none outline-none cursor-pointer"
        />
      </div>
